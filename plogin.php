...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
	...
	if(count($errors) == 0)
	{
		header("Location: Admin_Approval_Page.html");
		die;
	}
}
...
<head>
	...
	<link rel="stylesheet" href="CSS files/plogin.css">
		   ...
		   <form action=" " method="post">
			   ...
			   <div class="input-group">
				   ...
				   <div class="btmtxt">
				   		...
				   		<p>Don't have an Account <a class="click" href="psignup.php">Click Here</a></p>
					</div>
			   </div>
			   <div class="btn-field">
